...
-- vim.cmd('ab h3 ###')
-- vim.cmd('ab h4 ####')
vim.cmd([[iabbr h1 <C-o>0# <C-r>=expand("<cword>")<CR><CR>]])
vim.cmd([[iabbr h2 <C-o>0## <C-r>=expand("<cword>")<CR><CR>]])
vim.cmd([[iabbr h3 <C-o>0### <C-r>=expand("<cword>")<CR><CR>]])
vim.cmd([[iabbr h4 <C-o>0#### <C-r>=expand("<cword>")<CR><CR>]])
